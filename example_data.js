...
var items = [
    ...
    ["f", "AcceptabilityJudgment", {s: "Если бы их тоже все можно было экранизировать с этими актерами — то получился бы хороший фильм бы"},
          "Question",       {q: "Какой бы получился фильм?", as: ["хороший", "средний", "отличный"]}],
    ["f", "AcceptabilityJudgment", {s: "Итак, ссора начались разговора с о семье"},
          "Question",       {q: "Что началось с разговора о семье", as: ["ссора", "диалог", "расставание"]}],
    ["f", "AcceptabilityJudgment", {s: "С детьми поставили цели, чтобы через три года едем в Лондон"},
          "Question",       {q: "Куда планируют поехать через три года", as: ["В Лондон", "в Москву", "в Париж"]}],
    ["f", "AcceptabilityJudgment", {s: "Поэтому я ограничусь словами, что этот суп было на любителя"},
          "Question",       {q: "Что было на любителя", as: ["суп", "второе", "блюдо"]}],
    ["f", "AcceptabilityJudgment", {s: "Вопреки всем проблеме, концовка романа от этого выглядит не менее эффектной"},
          "Question",       {q: "Какой выглядит концовка романа?", as: ["эффектной", "удовлетворяющей", "захватывающей"]}],
    ["f", "AcceptabilityJudgment", {s: "Учителя устали одних от выполнений и тех же действия снова и снова"},
          "Question",       {q: "Кто устал?", as: ["учителя", "преподаватели", "студенты"]}],
    ["f", "AcceptabilityJudgment", {s: "Пока же в Средиземном море строится одна подводная ферма, на которых будут разводить асцидий"},
          "Question",       {q: "Что строится в Средиземном море", as: ["ферма", "завод", "предприятие"]}],
    ["f", "AcceptabilityJudgment", {s: "У любой картины есть не самые удачный штрих в ней"},
          "Question",       {q: "У чего есть не самые удачные штрихи", as: ["у картины", "у фильма", "у книги"]}],
    ["f", "AcceptabilityJudgment", {s: "Когда клуб обилия травм из-за оказался в кризисе, тренер совсем потерял голову"},
          "Question",       {q: "Что оказалось в кризисе", as: ["клуб", "команда", "сборная"]}],
    ["f", "AcceptabilityJudgment", {s: "И сразу я почувствовал и отсутствие портфеля, и испугавшись, но вспомнив, что портфель остался на работе"},
          "Question",       {q: "Что осталось на работе", as: ["портфель", "сумка", "рюкзак"]}],
    ["f", "AcceptabilityJudgment", {s: "И он вышел из своего тёплого дома в холодное утро и будет идёт навстречу другу"},
          "Question",       {q: "Навстречу кому он пойдет?", as: ["другу", "девушке", "компании"]}],
